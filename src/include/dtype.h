...
namespace graph {
    ...
    public:
         ...
         * @return
         */
        std::vector<Matrix> split(size_t num) {
            ...
            memcpy(last_part.data, data + (num - 1) * new_rows * new_stride, (new_rows + remaining) * new_stride);
