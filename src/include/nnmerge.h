...
namespace nnmerge {
    ...
    private:
        ...
        void mergeGraph(Graph &G_v);

        void build_internal() override;

        int applyUpdate(unsigned int sample) override;
    ...
    public:
        ...
        void Combine(const IndexPtr& index1, const IndexPtr& index2);
    };
}
